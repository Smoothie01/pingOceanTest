            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                        ...
                        <b-dropdown toggle-class="p-0 mr-2" menu-class="dropdown-menu-lg" variant="link" no-caret right>
                            <span slot="button-content">
                                <div class="icon-wrapper icon-wrapper-alt rounded-circle">
                                    <img width="42" class="rounded-circle" src="https://via.placeholder.com/95" alt="">
                                </div>
                            </span>
                                    ...
                                    <div class="menu-header-content text-left">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div v-if="userData" class="widget-heading">{{userData.name || "empty"}}</div>
                                                    <div v-if="userData" class="widget-subheading opacity-8">{{userData.email || "empty"}}</div>
                                                </div>
                            ...
                            <div class="scroll-area-xs" style="height: 150px;">
                                <VuePerfectScrollbar class="scrollbar-container" v-once>
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link">Phone :
                                            {{ userData.phone }}
                                        </a></li>
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link">Position :
                                            {{ userData.position }}
                                        </a></li>
                    ...
                    <div class="widget-content-left  ml-3 header-user-info">
                        <div  class="widget-heading">{{userData && userData.name}}</div>
                        <div class="widget-subheading">{{userData && userData.email}}</div>
                    </div>
