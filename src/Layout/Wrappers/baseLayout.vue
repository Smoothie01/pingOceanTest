<template>
    ...
    <div class="app-container app-theme-white">
        <transition name="fade" mode="out-in" appear>
            <Header :user-data="userData" :headerbg="headercolor"/>
        </transition>
        <transition name="fade" mode="out-in" appear>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async Authorization() {
                try{
                    const response = await fetch('https://dev-api.ringapp.me/auth', {
                        method: "POST",
                        headers: {
            ...
            async getData(){
                if(localStorage.getItem("token")){
                    const response = await fetch("https://dev-api.ringapp.me/profile",{
                        method:"GET",
                        headers:{
